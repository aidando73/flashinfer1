...
#ifdef ENABLE_FP8
// Per-tensor FP8 (IsMXFP8=false, the default)
...
// MXFP8 block-scaled FP8 (IsMXFP8=true)
...
// MXFP8 block-scaled FP8 (IsMXFP8=true)
template class CutlassMoeFCRunner<__nv_fp8_e4m3, __nv_fp8_e4m3, __nv_bfloat16, __nv_fp8_e4m3, __nv_bfloat16, true>;
#endif
#endif
#ifdef ENABLE_FP4
